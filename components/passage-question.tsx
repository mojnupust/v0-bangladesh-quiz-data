  ...
  return (
    <div className="mb-4 break-inside-avoid">
      ...
      <div className="bg-gray-50 border-l-2 border-gray-400 pl-3 pr-2 py-2 mb-2 print:bg-gray-100">
        <p className="font-serif text-sm leading-snug italic text-gray-800">
          <MathParagraph>{passage}</MathParagraph>
        </p>
        {passageImage && (
          <div className="mt-2">
            <Image
              ...
              <div key={idx} className="break-inside-avoid">
                <div className="flex gap-1.5">
                  <span className="font-semibold font-serif text-sm shrink-0">
                    {toBengaliNumber(questionNum)}।
                  </span>
                  <div className="flex-1">
                    <p className="font-serif text-sm leading-snug mb-1">
                      <MathParagraph>{childQ.question}</MathParagraph>
                    </p>
                    {childQ.image && (
                      <div className="mb-2">
                        <Image
                    ...
                    {childQ.questionEnd && (
                      <p className="font-serif text-sm mb-1.5 ml-3">
                        {childQ.questionEnd}
                      </p>
                    )}
